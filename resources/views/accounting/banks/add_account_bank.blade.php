      ...
      <div class="card">
            	...
            	<div class="form-group">   
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control " id="product_name" placeholder="Masukan Kode Akun" size="large" >
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control " id="product_name" placeholder="Pilih Kategori akun kas & bank" size="large" >
                    </div>
                  </div>				  
