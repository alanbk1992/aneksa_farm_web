 ...
 <!-- <div class="row"> -->
    ...
    <!-- Content Header (Page header) -->
            ...
            <h5 class="breadcrumb mb-4">
              ...
              <li class="breadcrumb-item active">Kirim Dana</li>
    </h5>
   ...
   <form class="form-horizontal">
      ...
      <div class="card">
              ...
              <div class="col-md-6">
              <div class="form-group">
                      <label for="exampleInputUsername1" class="font-weight-bold" >Bayar Dari</label>
              ...
              <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputUsername1" placeholder="Nama Karyawan">
                    </div>
              </div>
