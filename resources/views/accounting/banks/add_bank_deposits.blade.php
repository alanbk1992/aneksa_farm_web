 ...
 <!-- <div class="row"> -->
    ...
    <!-- Content Header (Page header) -->
            ...
            <h5 class="breadcrumb mb-4">
              ...
              <li class="breadcrumb-item active">Terima Dana</li>
    </h5>
   ...
   <form class="form-horizontal">
      ...
      <div class="card">
              ...
              <div class="col-md-6">
              <div class="form-group">
                      <label for="exampleInputUsername1" class="font-weight-bold" >Stor Ke</label>
                      <input type="text" class="form-control" id="exampleInputUsername1" placeholder="Pilih Akun kas Atau bank">
                    </div>
              </div>

              <div class="col-md-6">
                    <div class="form-group">
                      <label for="exampleInputUsername1" class="font-weight-bold" >Yang Membayar</label>
                      <input type="text" class="form-control" id="exampleInputUsername1" placeholder="Pilih Kontak supplier , karyawan dll">
                    </div>
              </div>
...
<div class="row">
	...
	<!-- end row -->		  
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputUsername1" placeholder="Ketik tag">
                    </div>
...
<div class="col-md-6">
                    <div class="form-group">
                     ...
                     <label for="exampleInputUsername1" class="font-weight-bold" >10.000.000</label>
                    </div>
              </div>
