 ...
 <!-- <div class="row"> -->
    ...
    <!-- Content Header (Page header) -->
            ...
            <h5 class="breadcrumb mb-4">
              ...
              <li class="breadcrumb-item"><a href="<?= url('accounting/expenses') ?>">Biaya</a></li>
   ...
   <form class="form-horizontal">
      ...
      <div class="card">
              ...
              <div class="col-md-6">
              <div class="form-group">
                      <label for="exampleInputUsername1" class="font-weight-bold" >Dibayar Dari</label>
                      <input type="text" class="form-control" id="exampleInputUsername1" placeholder="Pilih Akun kas & bank">
                    </div>
              </div>
              ...
              <div class="form-group">
					...
					Jika bayar nnti di ceklis , maka dibayar dari disabled , Tanggal Jatuh Tempo dan syarat pembayaran enabled
                   	<div class="form-check form-switch col-sm-2 mt-2">
					<input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault">
					<label class="form-check-label" for="flexSwitchCheckDefault">Bayar Nanti</label>
...
<div class="row">
              <div class="col-md-6">
              <div class="form-group">
                      <label for="exampleInputUsername1" class="font-weight-bold" >Penerima</label>
                      <input type="text" class="form-control" id="exampleInputUsername1" placeholder="Pilihan kontak">
                    </div>
              </div>
	...
	<!-- end row -->		  
                    ...
                    <div class="form-group">
                      <label for="exampleInputUsername1" class="font-weight-bold" >Cara Pembayaran</label>
                      <input type="text" class="form-control" id="exampleInputUsername1" placeholder="Pilihan Akun Kas & bank">
                    </div>
                    ...
                    <div class="form-group">
                      <label for="exampleInputUsername1" class="font-weight-bold" >Tanggal Jatuh Tempo</label>
                      <input type="text" class="form-control" id="exampleInputUsername1" placeholder="30/11/2022">
                    </div>

                    <div class="form-group">
                      <label for="exampleInputUsername1" class="font-weight-bold" >Syarat Pembayaran</label>
                      <input type="text" class="form-control" id="exampleInputUsername1" placeholder="Pilihan net 30 , COD dll">
                    </div>
...
<td>
<input type="text" class="form-control" id="exampleInputUsername1" placeholder="Pilih Pajak">
</td>
...
<div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <label for="exampleInputUsername1" class="font-weight-bold" >RP. 10.0000</label>
                    </div>
