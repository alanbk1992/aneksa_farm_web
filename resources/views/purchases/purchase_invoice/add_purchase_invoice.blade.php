 ...
 <!-- <div class="row"> -->
    ...
    <!-- Content Header (Page header) -->
            ...
            <h5 class="breadcrumb mb-4">
              ...
              <li class="breadcrumb-item"><a href="<?= url('purchases/purchase_invoice') ?>">Tagihan Pembelian</a></li>
              <li class="breadcrumb-item active">Tambah Tagihan Pembelian</li>
    </h5>
...
<div class="row">
	...
	<!-- end row -->		  
                    ...
                    <div class="form-group">
                      <label for="exampleInputUsername1" class="font-weight-bold" >Pilih Gudang</label>
...
<td>
<input type="text" class="form-control" id="exampleInputUsername1" placeholder="Pilihan Pajak PPH dll">
</td>
