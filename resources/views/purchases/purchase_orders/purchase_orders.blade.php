...
@section('body')
    ...
    <section class="content" >
      ...
      <div class="card">
       ...
       <div class="col-sm-6">
        <h3 class=" justify-content-center">Pesanan Pembelian</h3>
      </div>
      ...
      <div class="card-tools float-sm-right">
            ...
            <a title="Tambah Produk"  class="btn btn-sm  btn-primary" href="<?= url('/purchases/purchase_orders/add_purchase_order') ?>">Tambah Pesanan Pembelian</a>  
