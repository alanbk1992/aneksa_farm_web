...
@section('body')
    ...
    <section class="content" >
      ...
      <div class="card">
       ...
       <div class="col-sm-6">
        <h3 class=" justify-content-center">Pelanggan</h3>
      </div>
      ...
      <div class="card-tools float-sm-right">
            ...
            <a title="Tambah Produk"  class="btn btn-sm  btn-primary" href="<?= url('contacts/customers/add_customer') ?>">Tambah Pelanggan</a>  
